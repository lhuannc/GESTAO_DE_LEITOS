import { Company, Unit, Sector, Bed, BedStatus, ServiceType, ActionStatus, User, ServiceOrder, OSStatus, Team, ComplementItem } from '@gestao-leitos/types';
import { md5, unmaskCPF } from '@gestao-leitos/utils';
import { 
  INITIAL_COMPANY, 
  MOCK_USERS, 
  INITIAL_UNITS, 
