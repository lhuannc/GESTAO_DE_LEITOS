import { Company, Unit, Sector, Bed, ServiceType, ActionStatus, User, ServiceOrder, Team, ComplementItem, OSStatus, BedStatus, BedStatusConfig } from '@gestao-leitos/types';
import { 
  INITIAL_COMPANY, 
  MOCK_USERS, 
  INITIAL_UNITS, 
