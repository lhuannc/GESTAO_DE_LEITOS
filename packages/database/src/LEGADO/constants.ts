...
import { Company, Unit, Sector, Bed, ServiceType, ActionStatus, User, BedStatus, Team, ComplementItem, Step, BedStatusConfig } from '@gestao-leitos/types';
...
export const INITIAL_SERVICES: ServiceType[] = [
  { 
    ...
    config: {
      ...
      subOrders: [
        { stepId: 'stp-1', name: 'Limpeza Técnica', initialStatus: 'PENDENTE', targetTeamId: 'tm-1', allowedItemIds: ['it-1', 'it-2'] },
        { stepId: 'stp-2', name: 'Troca de Enxoval', initialStatus: 'BLOQUEADO', targetTeamId: 'tm-2', allowedItemIds: ['it-3', 'it-4'] }
      ]
    }
  }
];
